        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-yellow-700 mt-1">Close the current position and open a new one with updated
                        terms</p>
                </div>
                <button
                        type="button"
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4 space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mt-2">
                    Stock: <strong>{formData.stock}</strong> | Type:
                    <strong>{formData.type === 'P' ? 'Put' : 'Call'}</strong> |
